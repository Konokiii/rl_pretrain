...
#SBATCH --array=0-79 # here the number depends on number of tasks in the array, e.g. 0-11 will create 12 tasks
...
python exp/rebuttal/patch.py --setting ${SLURM_ARRAY_TASK_ID}
"