...
def main():
    ...
    ###########################################################
    exp_prefix = 'Init_cqlr3n'
    settings = [
        'env', '', ['hopper'],
        'dataset', '', ['medium'],
        'do_pretrain_only', 'preOnly', [True],
        'pretrain_mode', 'pre', ['mdp_same_noproj'],  # 'none', 'q_sprime', 'mdp_q_sprime'
        'qf_hidden_layer', 'l', [2],
        'mdppre_auto_dim', 'autoDim', [False],
        'mdppre_n_state', 'ns', [100],
        'mdppre_policy_temperature', 'pt', [1],
        'mdppre_same_as_s_and_policy', 'same', [True],
        'mdppre_state_dim', 'dimS', [3, 15, 50, 100, 300],
        'mdppre_action_dim', 'dimA', [3, 15, 50, 100, 300],
        'seed', '', [42],
    ]
